...
function preload() {
  img = loadImage('./assets/Chara1.png');
  bk_img = loadImage('./assets/back1.png');
  cloud_frt = loadImage('./assets/cloud_front.png');
  brick_img = loadImage('./assets/brick.png');
  front_layer1 = loadImage('./assets/front_layer1.png');
  front_layer2 = loadImage('./assets/front_layer2.png');
}
